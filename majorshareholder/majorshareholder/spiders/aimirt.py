...
class AimirtSpider(scrapy.Spider):
    name = 'aimirt'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=aimirt&ssoPageId=6&language=th&country=TH']
