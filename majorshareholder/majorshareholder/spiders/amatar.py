...
class AmatarSpider(scrapy.Spider):
    name = 'amatar'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=amatar&ssoPageId=6&language=th&country=TH']
