...
class BWorkSpider(scrapy.Spider):
    name = 'b-work'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=b-work&ssoPageId=6&language=th&country=TH']
