...
class CpnreitSpider(scrapy.Spider):
    name = 'cpnreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=cpnreit&ssoPageId=6&language=th&country=TH']
