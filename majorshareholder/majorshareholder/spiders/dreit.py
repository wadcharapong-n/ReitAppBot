...
class DreitSpider(scrapy.Spider):
    name = 'dreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=dreit&ssoPageId=6&language=th&country=TH']
