...
class FtreitSpider(scrapy.Spider):
    name = 'ftreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=ftreit&ssoPageId=6&language=th&country=TH']
