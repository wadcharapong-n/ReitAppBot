...
class GahreitSpider(scrapy.Spider):
    name = 'gahreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=gahreit&ssoPageId=6&language=th&country=TH']
