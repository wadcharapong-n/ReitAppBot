...
class GahreitSpider(scrapy.Spider):
    name = 'glandrt'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=glandrt&ssoPageId=6&language=th&country=TH']
