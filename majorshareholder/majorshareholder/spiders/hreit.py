...
class HreitSpider(scrapy.Spider):
    name = 'hreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=hreit&ssoPageId=6&language=th&country=TH']
