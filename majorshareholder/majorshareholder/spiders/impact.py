...
class HreitSpider(scrapy.Spider):
    name = 'impact'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=impact&ssoPageId=6&language=th&country=TH']
