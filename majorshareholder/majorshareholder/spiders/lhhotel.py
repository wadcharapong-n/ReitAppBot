...
class LhhotelSpider(scrapy.Spider):
    name = 'lhhotel'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=lhhotel&ssoPageId=6&language=th&country=TH']
