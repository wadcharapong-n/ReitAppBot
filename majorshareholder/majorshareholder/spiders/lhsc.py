...
class LhhotelSpider(scrapy.Spider):
    name = 'lhsc'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=lhsc&ssoPageId=6&language=th&country=TH']
