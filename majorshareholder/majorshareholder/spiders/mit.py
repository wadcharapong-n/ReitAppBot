...
class MitSpider(scrapy.Spider):
    name = 'mit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=mit&ssoPageId=6&language=th&country=TH']
