...
class ShreitSpider(scrapy.Spider):
    name = 'shreit'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=shreit&ssoPageId=6&language=th&country=TH']
