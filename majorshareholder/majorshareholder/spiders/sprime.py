...
class SprimeSpider(scrapy.Spider):
    name = 'sprime'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=sprime&ssoPageId=6&language=th&country=TH']
