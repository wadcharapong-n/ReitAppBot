...
class SripanwaSpider(scrapy.Spider):
    name = 'sripanwa'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=sripanwa&ssoPageId=6&language=th&country=TH']
