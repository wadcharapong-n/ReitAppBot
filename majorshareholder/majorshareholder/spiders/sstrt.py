...
class SstrtSpider(scrapy.Spider):
    name = 'sstrt'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=sstrt&ssoPageId=6&language=th&country=TH']
