...
class TprimeSpider(scrapy.Spider):
    name = 'tprime'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=tprime&ssoPageId=6&language=th&country=TH']
