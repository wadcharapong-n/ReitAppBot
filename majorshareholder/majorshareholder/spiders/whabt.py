...
class WhabtSpider(scrapy.Spider):
    name = 'whabt'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=whabt&ssoPageId=6&language=th&country=TH']
