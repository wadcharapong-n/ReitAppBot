...
class WhartSpider(scrapy.Spider):
    name = 'whart'
    urls = ['https://www.set.or.th/set/companyholder.do?symbol=whart&ssoPageId=6&language=th&country=TH']
